...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-purple-600 to-pink-500 text-white py-2 mb-20">
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        {/* Left Section: Privacy & Legal */}
        <div className="mb-2 md:mb-0 text-center md:text-left">
         
          <p>
            <a href="#" className="hover:underline">Contact GigWiz</a> | 
        ...
        <div className="mb-4 md:mb-0 text-center">
          ...
          <div className="flex space-x-4 justify-center">
            ...
            <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-200">
              <Twitter size={24} />
            </a>
            <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-200">
              <Linkedin size={24} />
            </a>
