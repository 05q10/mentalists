...
{/*        
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white text-gray-900 shadow-lg rounded-lg p-2">
                <a href="/profile" className="flex items-center px-3 py-2 hover:bg-gray-100 rounded-md">
                  <User className="w-5 h-5 mr-2" /> Profile
                </a>
                <a href="/settings" className="flex items-center px-3 py-2 hover:bg-gray-100 rounded-md">
          ...
          {/* Mobile Menu Toggle */}
          <button className="md:hidden block" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
